...
SwarmCatalogIndex &SwarmCatalog::index() {
  return impl_->index;
}

const SwarmCatalogIndex &SwarmCatalog::index() const {
  return impl_->index;
}

const PublicationLedger &SwarmCatalog::ledger() const {
  return impl_->ledger;
}
...
void SwarmCatalog::seedDefaultDocuverse() {
  ...
  impl_->authors = {
      AuthorNode{
          ...
          .pubKeyHex        = "9f4a28c1e7a8b9c1d2e3f4a5b6c7d8e0123456789abcdef0123456789abcdef0",
          .seederNodes      = 14,
          .publicationCount = 2,
      },
      AuthorNode{
          ...
          .pubKeyHex        = "8b31a5f0fedcba9876543210fedcba0123456789abcdef0123456789abcdef0",
          .seederNodes      = 12,
          .publicationCount = 1,
      },
      AuthorNode{
          ...
          .pubKeyHex        = "7b8c9d01cdef0123456789abcdef0123456789abcdef0123456789abcdef012",
          .seederNodes      = 8,
          .publicationCount = 1,
      },
  };
  ...
  // 2. Topic Swarms
  impl_->topics = {
      TopicSwarmNode{.topic = "hypertext", .infoHash = "a1b2c3d4e5f60718293a4b5c6d7e8f901a2b3c4d", .activePeers = 38, .publicationCount = 4},
      TopicSwarmNode{.topic = "transclusion", .infoHash = "b2c3d4e5f60718293a4b5c6d7e8f901a2b3c4d5e", .activePeers = 24, .publicationCount = 2},
      TopicSwarmNode{.topic = "distributed-os", .infoHash = "c3d4e5f60718293a4b5c6d7e8f901a2b3c4d5e6f", .activePeers = 19, .publicationCount = 2},
      TopicSwarmNode{.topic = "typography", .infoHash = "d4e5f60718293a4b5c6d7e8f901a2b3c4d5e6f70", .activePeers = 15, .publicationCount = 1},
      TopicSwarmNode{.topic = "transcopyright", .infoHash = "e5f60718293a4b5c6d7e8f901a2b3c4d5e6f7081", .activePeers = 7, .publicationCount = 1},
  };
  ...
  PublicationEntry doc1{
      ...
      .abstractText      = "Theodor Holm Nelson's foundational thesis on non-destructive quotation, coordinate space invariance, and the elimination of copy-paste clipboard silos in universal literature.",
  ...
  PublicationEntry doc2{
      ...
      .abstractText      = "A conceptual framework for the augmentation of man's intellect through interactive computing, associative trails, and shared collaborative hypermedia.",
  ...
  PublicationEntry doc3{
      ...
      .abstractText      = "Alan Kay and Adele Goldberg's foundational vision of the Dynabook: an active, personal, dynamic medium for creative thought and multidimensional communication.",
  ...
  PublicationEntry doc4{
      ...
      .abstractText      = "Permissionless quotation with direct reader-to-author micropayment state channels. Anyone may quote without prior license; reading triggers per-byte settlement.",
