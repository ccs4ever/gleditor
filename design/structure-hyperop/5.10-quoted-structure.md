...
[§5.5](5.05-extern-refs.md) for persistent boundary references, [§5.6](5.06-compact-binary-v4.md)
for their stable wire form, and [§5.7](5.07-arena-federation.md) for identity-preserving spaces and
...
`d.scroll-refs` membership rank — [§5.5 §2](5.05-extern-refs.md)'s compaction claim, earning its
keep at the first real caller.
...
chain ([§5.1](5.01-cell-history.md)), so "what was I running last week" is answerable, which the
