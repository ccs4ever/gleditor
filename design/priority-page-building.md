...
past 256x256 crashes deterministically with a RADV `context is lost` GPU error on this machine,
reproduced on every retry. Genuine and unrelated to Stage 5 or to the fixes above -- filed as its
own issue rather than chased down here.
