 ...
 * @brief Unit tests for GroundingModal form presentation, source selection, and paste rejection.
 */
...
TEST(GroundingModalTest, PopulateKnownSourcesChoice) {
  ...
  std::vector<gleditor::KnownSource> sources = {
      {.displayName  = "Literary Machines (1987)",
       .pathOrMagnet = "magnet:?xt=urn:btih:1111111111111111111111111111111111111111",
       .mimeType     = "text/plain",
       .infoHash     = "1111111111111111111111111111111111111111"},
      {.displayName  = "Nelson Keynote Audio",
       .pathOrMagnet = "magnet:?xt=urn:btih:2222222222222222222222222222222222222222",
       .mimeType     = "audio/flac",
